...
app.get('/products/search/:query', users.userCheck, Products.search);
...
app.get('/categories/search/:query', users.userCheck, categories.search);
...
app.get('/sales/search/:query', users.userCheck, sales.search);
...
app.get('/purchases/search/:query', users.userCheck, purchases.search);
...
app.get('/suppliers/search/:query', users.userCheck, suppliers.search);
...
app.get('/users/search/:query', users.userCheck, users.search);
